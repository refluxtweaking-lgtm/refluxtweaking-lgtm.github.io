...
export const tweaks: Tweak[] = [
  ...
  { id: "n3", name: "Optimize TCP/IP Stack", description: "Tunes Windows network stack for gaming", category: "Network", plans: { ...paidOnly } },
  { id: "n4", name: "Disable Network Throttling", description: "Removes Windows multimedia throttling", category: "Network", plans: { ...paidOnly } },
  ...
  { id: "n6", name: "Low-Latency NIC Tuning", description: "Reduces interrupt moderation on your adapter", category: "Network", plans: { ...paidOnly } },
  { id: "n7", name: "MTU Auto-Optimization", description: "Finds ideal packet size for your connection", category: "Network", plans: { ...paidOnly } },
  ...
  { id: "n10", name: "UDP Buffer Optimization", description: "Improves hit registration in shooters", category: "Network", plans: { ...paidOnly } },
  ...
  { id: "c3", name: "Processor Performance Boost", description: "Maximizes turbo boost behavior", category: "CPU & Power", plans: { ...paidOnly } },
  { id: "c4", name: "Disable C-States", description: "Prevents CPU sleep during gameplay", category: "CPU & Power", plans: { ...paidOnly } },
  { id: "c5", name: "Timer Resolution Boost", description: "1ms system timer for smoother frames", category: "CPU & Power", plans: { ...paidOnly } },
  { id: "c6", name: "HPET Optimization", description: "Reduces input latency from timer source", category: "CPU & Power", plans: { ...paidOnly } },
  { id: "c7", name: "Background Process Limiter", description: "Frees CPU for your game", category: "CPU & Power", plans: { ...paidOnly } },
  ...
  { id: "g2", name: "Hardware-Accelerated GPU Scheduling", description: "Reduces render queue latency", category: "GPU & Display", plans: { ...paidOnly } },
  ...
  { id: "m2", name: "Page File Optimization", description: "Tunes virtual memory for your RAM size", category: "Memory & Storage", plans: { ...paidOnly } },
  ...
  { id: "m5", name: "Memory Compression Toggle", description: "Reduces RAM overhead on low-memory rigs", category: "Memory & Storage", plans: { ...paidOnly } },
  ...
  { id: "s2", name: "Telemetry Disable Pack", description: "Cuts Windows data collection overhead", category: "System & Services", plans: { ...paidOnly } },
  { id: "s3", name: "Bloatware Service Remover", description: "Disables non-essential Windows services", category: "System & Services", plans: { ...paidOnly } },
  ...
  { id: "s8", name: "Priority Boost for Games", description: "Sets high process priority automatically", category: "System & Services", plans: { ...paidOnly } },
  ...
  { id: "cl2", name: "Disk Cleanup Automation", description: "Runs Windows Disk Cleanup silently", category: "Cleanup & Maintenance", plans: { ...paidOnly } },
  { id: "cl3", name: "Shader & DirectX Cache Wipe", description: "Frees GBs of stale GPU cache", category: "Cleanup & Maintenance", plans: { ...paidOnly } },
