export function AmbientBackground() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-15" aria-hidden="true">
      ...
      <div className="ambient-orb top-glow-orb top-glow-orb-center" style={{ animationDelay: "-4s" }} />
      <div
        className="ambient-orb hero-glow absolute bottom-[8%] left-[15%] h-[360px] w-[360px] rounded-full bg-reflux-accent/18 blur-[90px]"
